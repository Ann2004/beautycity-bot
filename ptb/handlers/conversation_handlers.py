...
from .callback_handlers import (
    ...
    handler_phone_menu, handler_promo_menu, handler_appointment_menu,
    handler_after_appointment, handler_master_menu
)
...
conversation_handler = ConversationHandler(
    ...
    states={
        ...
        states_bot.PROMO: [
            CallbackQueryHandler(handler_promo_menu),
            MessageHandler(filters.TEXT & ~filters.COMMAND, handler_promo_menu)
        ],
